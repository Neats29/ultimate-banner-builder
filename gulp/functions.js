...
//
export function checkSettingsAndRun(setting, execute, usingPath) {
  if (setting) {
    execute(usingPath);
  }
}
...
var sizeFolder;
export function getSubDirectories(fileType, copyFunc, Static) {
...
// Open in browsers
export function connectOptions(browser, port, live) {
  return {
    root: ['./prod/'],
    port: port,
    livereload:  {
